...
ClapTrap::ClapTrap() : _p_f(10) , _p_e(10), _d_a(0)
{
	std::cout << "\033[32mDefault costructor\033[37m" << std::endl;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _p_f(10) , _p_e(10), _d_a(0)
{
	std::cout << "\033[32mCostructor name\033[37m" << std::endl;
}
...
ClapTrap::~ClapTrap(){
	std::cout << "\033[31mDestructor\033[37m" << std::endl;
}
...
{
	if(amount > 0)
		std::cout << "\033[32m(ClapTarap ha danneggiato ) "  << amount << "\033[37m" << std::endl;
	else if(amount == 0)
...
void ClapTrap::beRepaired(unsigned int amount)
{
	if(amount > 0)
	{
		std::cout << "\033[34m" << _name << " si stata riparando cosi puo recuperare un punto vita\033[37m" << std::endl;
		if(getF() < 10)
		{
			setF(getF() + 1);
		...
		amount -= 1;
		setE(amount);
		std::cout << "\033[33ml'energia rimasta e' = \033[37m" << amount << std::endl;
	}
	else
