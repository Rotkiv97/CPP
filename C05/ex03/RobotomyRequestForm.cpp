...
AForm *RobotomyRequestForm::clone(AForm *AForm){
    AForm = new RobotomyRequestForm(getModulo());
    return(AForm);
}

void RobotomyRequestForm::constexecute(Bureaucrat const &executor) const{
